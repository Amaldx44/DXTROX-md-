...
`.trim()
        if (room.x !== room.o) await conn.sendButton(room.x, str, author, ['GiveUp', 'giveup'], m, {
            mentions: conn.parseMention(str)
        })
        await conn.sendButton(room.o, str, author, ['GiveUp', 'giveup'], m, {
            mentions: conn.parseMention(str)
        })
    } else {
        room = {
        ...
        m.reply('Waiting for partner' + (text ? ` Waiting for partner
