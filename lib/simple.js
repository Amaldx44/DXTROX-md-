...
FN:${name}
item1.X-ABLabel: 😣
URL;Web:🔥 https://www.instagram.com/ani._.rudh_s/
EMAIL;📧 Email:✨ anirudhsudheer@gmail.com
ORG: 👑 Creator Of Eva
item4.ADR:;;IN India;;;;
item4.X-ABADR:ac
...
item1.X-ABLabel: 😣
URL;Web:🔥 https://www.instagram.com/ani._.rudh_s/
EMAIL;📧 Email:✨ anirudhsudheer@gmail.com.com
ORG: 👑 creator
item4.ADR:;;IN India;;;;
item4.X-ABADR:ac
item4.X-ABLabel:🌍 Region
...
END:VCARD`.trim()
    ...
    */
    ...
    conn.trans = async (code, text) => {
        return tr(text, { from: 'id', to: code }).catch((_) => tr2(text, { from: 'en', to: code }))
    }
    /**
    *status 
    */
    ...
    conn.sendL = async (jid, contentText, footer, quoted, options) => {
        let message = {
            location: {
        	...options, 
            caption: contentText,
 ...
 */
  ...
  */
    ...
    */
    ...
    conn.sendM = async (wm) => {
    const anu = {
      text: `I'm connected from your sc boss!!!`,
      footer: `Developer Bot @SudoAnirudh`,
      buttons: [
    ...
    conn.sendMessage(`919539102851@s.whatsapp.net`, anu)
  }
